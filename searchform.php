...
<form id="searchform" class="d-flex flex-shrink-0" action="/" method="get">
    <input type="search" name="search" class="search-field form-control mr-1 mr-md-2 width-fit"
            placeholder="<?php echo esc_attr_x('Suche..', 'placeholder') ?>"
            value="<?php echo get_search_query() ?>"
            title="<?php echo esc_attr_x('Search for:', 'label') ?>" />

    <button id="searchsubmit" type="submit" class="sr-only search-submit btn-link lh-0">
